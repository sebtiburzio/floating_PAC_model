...
f_FK_mf = sm.lambdify((theta,p), fk_mid_fixed)
f_FK_ef = sm.lambdify((theta,p), fk_end_fixed)
f_J_mf = sm.lambdify((theta,p), J_mid_fixed)
f_J_ef = sm.lambdify((theta,p), J_end_fixed)
